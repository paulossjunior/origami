...
function registerGeneratorCommand(context: vscode.ExtensionContext): void {
    ...
    context.subscriptions.push(vscode.commands.registerCommand("origami.generate",callback));
...
function startLanguageClient(context: vscode.ExtensionContext): LanguageClient {
    ...
    const fileSystemWatcher = vscode.workspace.createFileSystemWatcher('**/*.origami');
